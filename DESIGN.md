...
### セマンティックカラー（PFCサマリー専用）

| 栄養素 | 背景 | テキスト |
|---|---|---|
| P タンパク質 | `bg-blue-500/10` | `text-blue-600 dark:text-blue-400` |
| F 脂質 | `bg-yellow-500/10` | `text-yellow-600 dark:text-yellow-400` |
| C 炭水化物 | `bg-green-500/10` | `text-green-600 dark:text-green-400` |
| カロリー | `bg-orange-500/10` | `text-orange-600 dark:text-orange-400` |
...
- セマンティックカラーはPFCサマリーの4要素のみに限定する
- それ以外のコンポーネントにアドホックな色を使わない
